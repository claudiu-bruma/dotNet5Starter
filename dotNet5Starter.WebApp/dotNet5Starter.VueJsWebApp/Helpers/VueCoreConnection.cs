...
namespace dotNet5Starter.VueJsWebApp.Helpers
{
    public static class VueCoreConnection
    {
        ...
        public static void UseVueDevelopmentServer(this ISpaBuilder spa, string spaFolderName)
        {
            spa.UseProxyToSpaDevelopmentServer(async () =>
            {
                ...
                var processInfo = new ProcessStartInfo
                {
                    ...
                    WorkingDirectory = spaFolderName,
